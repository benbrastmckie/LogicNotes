...
\begin{enumerate}[leftmargin=1.2in,itemsep=2pt] %,label=(\arabic*)]%,label=\roman*]
...
\begin{enumerate}[leftmargin=1.2in,itemsep=1pt]\small
    ...
    \begin{multicols}{2}
      ...
      \item $\Kproves \metaA \strictif (\metaB \strictif \metaA)$.
      \item $\Kproves \neg\metaB \strictif (\metaA \strictif \metaB)$.
    \end{multicols}
    \begin{multicols}{2}
